...
class Offer{
	...
	private function load(){
		$sql = "SELECT `id`, `title`, `subtitle`, `text`, `image`, `published` FROM `offer` WHERE `id`=".$this->id.";";
		$con = $GLOBALS['SQL'];
	...
	public function insert(){
		...
		$sql = "INSERT INTO `offer`(`id`, `text`, `title`, `subtitle`, `image`, `published`) VALUES ("
	...
	public function delete(){
		$sql = "DELETE FROM `offer` WHERE id=". $this->id .";";
		$con = $GLOBALS['SQL'];
