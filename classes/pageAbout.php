...
class PageAbout{
	...
	public function __construct($Pid='', $PuserId='', $Ptitle='', $Psubtitle='', $Ptext=0, $Pimage='', $Ppublished=''){
	...
	private function load(){
		$sql = "SELECT `id`, `userId`, `title`, `subtitle`, `text`, `image`, `published` FROM `pageabout` WHERE `id`=".$this->id.";";
		$con = $GLOBALS['SQL'];
	...
	public function insert(){
		...
		$sql = "INSERT INTO `pageabout`(`id`, `userId`, `text`, `title`, `subtitle`, `image`, `published`) VALUES ("
	...
	public function delete(){
		$sql = "DELETE FROM `pageabout` WHERE id=". $this->id .";";
		$con = $GLOBALS['SQL'];
